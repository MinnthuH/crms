...
@section('header')
    <div class="tw-flex tw-justify-between tw-items-center">
        <div class="tw-flex tw-justify-between tw-items-center">
            ...
            <h5 class="tw-text-lg tw-mb-0 tw-p-3">Edit Ticket Price</h5>
        </div>
        <div class=""></div>
...
@section('content')
    ...
    <x-card class="tw-mb-5">
        ...
        <form method="post" action="{{ route('ticket-price.update', $ticketPrice->id) }}" class="" id="submit-form">
            @csrf
            @method('put')
...
@endsection
@push('scripts')
    {!! JsValidator::formRequest('App\Http\Requests\TicketPriceUpdateRequest', '#submit-form') !!}
@endpush
