...
@section('header')
    <div class="tw-flex tw-justify-between tw-items-center">
        <div class="tw-flex tw-justify-between tw-items-center">
            ...
            <h5 class="tw-text-lg tw-mb-0 tw-p-3">Edit Hall</h5>
        </div>
        <div class=""></div>
...
@section('content')
    ...
    <x-card class="tw-mb-5">
        ...
        <form method="post" action="{{ route('hall.update', $hall->id) }}" class="" id="submit-form">
            @csrf
            @method('put')
...
@endsection
@push('scripts')
    {!! JsValidator::formRequest('App\Http\Requests\HallUpdateRequest', '#submit-form') !!}
@endpush
