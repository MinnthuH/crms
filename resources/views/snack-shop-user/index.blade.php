...
<div class="tw-flex tw-justify-between tw-items-center">
    <div class="tw-flex tw-justify-between tw-items-center">
        ...
        <h5 class="tw-text-lg mb-0">Snack Shop User</h5>
    </div>
    <div>
        <x-create-button href="{{ route('snack-shop-user.create') }}"><i class="fas fa-plus-circle tw-mr-1"></i>create</x-create-button>
    </div>
</div>
@endsection
    ...
    <table class="table table-bordered DataTable-tb">
        <thead>
            <tr>
                ...
                <th class="text-center">Snack Shop</th>
...
<script>
    $(document).ready(function() {
        var table = new DataTable('.DataTable-tb', {
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('snack-shop-user.datatable') }}",
            },
            columns: [{
